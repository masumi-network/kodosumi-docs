...
async function generateLLMsTxt() {
  ...
  try {
    ...
    const content = [
      ...
      '',
      '### Examples:',
      '- https://docs.kodosumi.io/documentation/getting-started.md',
      '- https://docs.kodosumi.io/api/payment-service.md',
      '- https://docs.kodosumi.io/guides/agent-integration.md',
      '',
      '### Markdown Index:',
